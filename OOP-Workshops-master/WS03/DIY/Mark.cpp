...
namespace sdds {
	...
	double Mark::GPA()const {
		...
		double gpa;						// This function is taking grade and turning into precise GPA value
		gpa = rawValue() * 4;			//can multiply a function directly because rawValue returns a double
		return gpa;
	}

	double Mark::letterBasedGPA()const {			// This function takes grade and turns into general GPA value
